...
<section style="max-width:720px;margin:0 auto;">
    ...
    <div style="background: var(--surface-strong);padding:18px;border-radius:12px;border:1px solid var(--border);">
        @if(session('success'))
            <div style="background: rgba(126,187,152,0.15); border:1px solid var(--success); padding:10px; border-radius:8px; margin-bottom:10px; color: var(--dark); font-weight: 600;">{{ session('success') }}</div>
        @endif
