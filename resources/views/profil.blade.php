...
<section>
    <div style="display:flex;gap:24px;align-items:flex-start;">
        <div style="flex:1;">
            <div style="background:white;padding:20px;border-radius:12px;border:1px solid var(--border);box-shadow:0 6px 18px rgba(99,102,241,0.06);">
                <div style="display:flex;gap:16px;align-items:center;margin-bottom:12px;">
                    ...
                    <div>
                        ...
                        <div style="color:#6b7280;font-size:0.95em;">{{ $user->email }}</div>
                    </div>
                </div>

                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:8px;">
                    <div>
                        <div style="color:#6b7280;font-size:0.85em;">No. Telepon</div>
                        <div style="font-weight:600">{{ $user->phone ?? '-' }}</div>
                    </div>
                    <div>
                        <div style="color:#6b7280;font-size:0.85em;">Terdaftar</div>
                        <div style="font-weight:600">{{ optional($user->created_at)->format('d M Y') ?? '-' }}</div>
                    </div>
                </div>

                <div style="margin-top:12px;">
                    <div style="color:#6b7280;font-size:0.85em;">Alamat</div>
        ...
        <div style="width:320px;">
            <div style="background:#fff;padding:16px;border-radius:12px;border:1px solid var(--border);">
                ...
                <p style="color:#6b7280;font-size:0.95em;">Kelola data kontakmu, lihat notifikasi, dan periksa status pesanan dari panel ini.</p>
                <ul style="margin-top:8px;list-style:none;padding:0;color:#6b7280;font-size:0.95em;">
