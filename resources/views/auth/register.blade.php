    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .logo-mark {
            ...
            box-shadow: 0 8px 24px rgba(99,102,241,0.30), inset 0 1px 0 rgba(255,255,255,0.25);
            margin-bottom: 14px;
...
<body>
    ...
    <script>
        ...
        function updatePasswordStrength() {
            ...
            const states = [
                { width: '0%', text: 'Kekuatan password: belum diisi', color: '#ef4444' },
                { width: '20%', text: 'Sangat lemah', color: '#ef4444' },
                { width: '40%', text: 'Lemah', color: '#f97316' },
                { width: '60%', text: 'Cukup', color: '#f59e0b' },
                { width: '80%', text: 'Bagus', color: '#22c55e' },
                { width: '100%', text: 'Kuat', color: '#16a34a' },
            ];
